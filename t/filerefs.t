...
is(MogileFS::Plugin::FileRefs::add_file_ref($query, {dmid => undef, dkey => "zz", ref => "00001"}), "0");
is($sent_to_parent, "ERR add_file_ref_fail add_file_ref_fail");

is(MogileFS::Plugin::FileRefs::add_file_ref($query, {dmid => 1, dkey => "zz", ref => "00001"}), "1");
...
is(MogileFS::Plugin::FileRefs::del_file_ref($query, {dmid => 1, dkey => "zz", ref => "00001"}), "1");
...
is(MogileFS::Plugin::FileRefs::rename_if_no_refs($query, {dmid => 1, from_key => "zz", to_key => "yy"}), "1");
...
is(MogileFS::Plugin::FileRefs::list_refs_for_dkey($query, {dmid => 1, dkey => "zz"}), "1");
...
is(MogileFS::Plugin::FileRefs::add_file_ref($query, {dmid => 1, dkey => "zz", ref => "00002"}), "1");
is(MogileFS::Plugin::FileRefs::list_refs_for_dkey($query, {dmid => 1, dkey => "zz"}), "1");
is($sent_to_parent, "OK ref_1=00002&total=2&ref_0=00001");

is(MogileFS::Plugin::FileRefs::add_file_ref($query, {dmid => 1, dkey => "yy", ref => "00003"}), "1");
is(MogileFS::Plugin::FileRefs::list_refs_for_dkey($query, {dmid => 1, dkey => "zz"}), "1");
is($sent_to_parent, "OK ref_1=00002&total=2&ref_0=00001");
